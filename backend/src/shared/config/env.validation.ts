...
const envSchema = z
  .object({
    ...
    IDENTITY_SESSION_TTL_SECONDS: z.coerce
      .number()
      .int()
      .positive()
      .default(1800),
    ...
    IDENTITY_LDAP_PORT: z.coerce
      .number()
      .int()
      .positive()
      .max(65535)
      .default(389),
    IDENTITY_LDAP_BIND_DN: z
      .string()
      .min(1)
      .default("cn=admin,dc=raptorgate,dc=local"),
    ...
    IDENTITY_LDAP_GROUP_MEMBER_ATTRIBUTE: z
      .string()
      .min(1)
      .default("memberUid"),
